                      ...
                      <div class="tab-pane fade show active" id="tab-product-details" role="tabpanel" aria-labelledby="ex1-tab-1">
                        {{ Form::model($price, array('route' => array('price.update', $price->id), 'method' => 'PUT')) }}
                            ...
                            <div class="mb-3">
                                ...
                                {{ Form::text('name', $price->name ?? null , array('class' => 'form-control')) }}
                            </div>
                            <div class="mb-3">
                                {{ Form::label('probability', 'Probability', ['class'=>'form-label']) }}
                                {{ Form::number('probability_percentage', $price->probability_percentage ?? null, array('class' => 'form-control','min' => '0','max' => '100', 'placeholder' => '0 - 100','step' => '0.01')) }}
